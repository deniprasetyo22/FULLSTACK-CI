...
<div class="container mx-auto p-6 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
    <form action=" <?= url_to('auth-store-user') ?>" method="POST" id="formData">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="full_name" data-pristine-required
        ...
        <div class="mb-4">
            ...
            <input type="email" name="email" data-pristine-required data-pristine-required-message="Email is required"
        ...
        <div class="mb-4">
            ...
            <select name="role" id="role" data-pristine-required data-pristine-required-message="Role is required"
