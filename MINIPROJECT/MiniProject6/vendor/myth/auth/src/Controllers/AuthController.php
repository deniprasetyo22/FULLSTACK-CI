...
class AuthController extends Controller
{
    ...
    public function attemptRegister()
    {
        ...
        if ($savedUser) {
            // /* Admin Group */
            // $adminGroup = $this->groupModel->where('name', 'administrator')->first();
            // if ($adminGroup) {
            //     $this->groupModel->addUserToGroup($savedUser->id, $adminGroup->id);
            // }

            // /* Product Manager Group */
            // $productManagerGroup = $this->groupModel->where('name', 'product_manager')->first();
            // if ($productManagerGroup) {
            //     $this->groupModel->addUserToGroup($savedUser->id, $productManagerGroup->id);
            // }

            /* Customer Group */
            $customerGroup = $this->groupModel->where('name', 'customer')->first();
            if ($customerGroup) {
                $this->groupModel->addUserToGroup($savedUser->id, $customerGroup->id);
            }
            ...
            $userProfileData = [
                ...
                'full_name'       => $fullName,
                // 'role'            => $adminGroup->name,
                // 'role'            => $productManagerGroup->name,
                'role'            => $customerGroup->name,
                'status'          => 'Active',
                'user_id'         => $savedUser->id
            ];
    
            log_message('debug', 'Inserting user profile: ' . print_r($userProfileData, true));
            $this->userProfileModel->insert($userProfileData);
            log_message('debug', 'Insert completed');
