...
<div class="container mx-auto p-6 h-full bg-white p-6 rounded-lg shadow">
    ...
    <div class="mb-4">
        <a href="<?= url_to('auth-create-user') ?>"
            class="bg-blue-500 hover:bg-blue-600 text-white py-1.5 px-3 rounded">
        ...
        <table class="min-w-full bg-white rounded-lg shadow-md">
            <thead class="bg-blue-500">
                <tr>
                    ...
                    <th class="p-2 text-center font-semibold text-white border border-gray-300">Email</th>
                    ...
                    <th class="p-2 text-center font-semibold text-white border border-gray-300">Change Role</th>
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-100 transition">
                    ...
                    <td class="p-2 border border-gray-300 text-center">
                        <span
                            class="text-white py-1.5 px-3 rounded <?php if($user->status == 'Active') echo 'bg-green-500'; else echo 'bg-red-500'; ?>"><?= esc($user->status) ?></span>
                    </td>
                    <td class="p-2 border border-gray-300 text-center">
                        <a href="<?= esc(url_to('auth-change-role', $user->id)) ?>"
                            class="bg-yellow-500 hover:bg-yellow-600 text-white py-1.5 px-3 rounded">
                            Change Role
                        </a>
                    </td>
                    <td class="p-2 flex justify-center space-x-2 border border-gray-300">
                        <a href="<?= esc(url_to('auth-user-profile', $user->id)) ?>"
                            class="text-blue-500 hover:text-blue-600">
                            <i class="fa-solid fa-eye"></i>
                        </a>
                        <a href="<?= esc(url_to('auth-edit-user', $user->id)) ?>"
                            class="text-yellow-500 hover:text-yellow-600">
                            <i class="fa-solid fa-edit"></i>
                        </a>
                        <form action="<?= esc(url_to('auth-delete-user', $user->id)) ?>" method="post">
