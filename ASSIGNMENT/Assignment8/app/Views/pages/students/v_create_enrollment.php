...
<div class="flex flex-col space-y-4 p-6 bg-white shadow rounded-lg h-full">
    <a href="<?= url_to('student/enrollment/my-enrollments') ?>" class="text-blue-500 hover:underline">
    ...
    <form action="<?= url_to('student/enrollment/store-enrollment') ?>" method="post" id="formData" novalidate>
        <?= csrf_field() ?>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="student_name" value="<?= $student->name ?>" disabled
                class="w-full border border-gray-300 bg-gray-100 rounded p-2 cursor-not-allowed">
